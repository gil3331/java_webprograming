...
public class InputClass {
	...
	public void inputCountCommand(int tryCount) {

		do {
			try {
				System.out.println("몇 장을 주문하시겠습니까? : ");
				inputCount[tryCount] = in.nextInt();// 몇장을 구매할지 기입
			} catch (Exception e) {
				in.nextLine();
			}
		} while (inputCount[tryCount] <= 0 || inputCount[tryCount] >= 10);// 티켓 수는 1~9장 정도로 정하고, 그 이상은 주문하지 못하게 함.
