...
<body onload='ScreenShow(0);'>
	<div id="container"
		...
		<div id="header1" 
			style="z-index:15; height: 35px; width: 10%; float: left; vertical-align: middle;" onclick='history.go(-1);'>
			<img src="photo/back.png">
		</div>
		<div id="header2"
			style="z-index:15; height: 35px; width: 80%; float: left; vertical-align: middle; text-align: center"><font size=5%>모바일리조트(링조트)</font></div>
		<div id="header3"
			style="z-index:15; height: 35px; width: 10%; float: left; vertical-align: middle;" onclick='ScreenShow(0)'>
...
<div>
		...
		<div id="s4"
			style="height: 200px; background-color: #5f5f5f; display: none;"><jsp:include page="b_01.html"/></div>
		<div id="s5"
			style="height: 200px; background-color: #5f5f5f; display: none;"><jsp:include page="b_02.html"/></div>
		<div id="s6"
			style="height: 200px; background-color: #5f5f5f; display: none;"><jsp:include page="b_03.html"/></div>
		<div id="s7"
			style="height: 200px; background-color: #5f5f5f; display: none;"><jsp:include page="c_01.html"/></div>
		<div id="s8"
			style="height: 200px; background-color: #5f5f5f; display: none;"><jsp:include page="c_02.html"/></div>
		<div id="s9"
			style="height: 200px; background-color: #5f5f5f; display: none;"><jsp:include page="c_03.html"/></div>
		<div id="s10"
			style="height: 200px; background-color: #5f5f5f; display: none;"><jsp:include page="d_01.jsp"/></div>
		<div id="s11"
			style="height: 200px; background-color: #5f5f5f; display: none;"><jsp:include page="d_02.html"/></div>
		<div id="s12"
			style="height: 200px; background-color: #5f5f5f; display: none;"><jsp:include page="adm_allview.jsp"/></div>
		<div id="s13"
			style="height: 200px; background-color: #5f5f5f; display: none;"><jsp:include page="adm_logout.jsp"/></div>
		<div id="s14"
			style="height: 200px; background-color: #5f5f5f; display: none;"><jsp:include page="e_01.jsp"/></div>
</div>

	<div style="background-color:white; width:device-width; height:45%">
