			...
			<tr>
				...
				<table border=3 align="center" rules=rows bordercolor=#FFFFFF
					...
					out.println("<div align='center'>");
						if (startPage > 1) {
							out.println("<a href='e_01.jsp?Page=1&countList=5'>&lt;</a>");
						}
						...
						for (int iCount = startPage; iCount <= endPage; iCount++) {
							if (iCount == correntPage) {
								out.println("<a href='e_01.jsp?Page=" + iCount + "&countList=5'>" + iCount + "</a>");
							} else {
								out.println("<a href='e_01.jsp?Page=" + iCount + "&countList=5'>" + iCount + "</a>");
							}
						}
						...
						if ((correntPage + 1) < totalPage) {
							out.println("<a href='e_01.jsp?Page=" + ((correntPage + 1) + 1) + "&countList=5'>&gt;</a>");
						}

						if (endPage < totalPage) {
							out.println("<a href='e_01.jsp?Page=" + totalPage + "&countList=5'>&gt;&gt;</a>");
						}
					out.println("</div>");
					%>
